...
class Sale extends Model
{
    ...
    public static $rules = [
        ...
        'movies' => 'required',
        'movies' => 'required',
        'numberOfMoviesOrHour' => 'required',
        'startTime' => 'required',
        'endTime' => 'required',
        'numberOfExtraPerson' => 'required',
        'additionalTimeFee' => 'required',
        'corkageFee' => 'required',
        
    ];


/// ADD TIMES SOLD TO PRODUCT
     ...
     */
    protected $fillable = [
        'customer_id','cashier_id','comments',
        'roomType','roomPrice',
        'promoType','promoPrice',
        'session',
        'movies',
