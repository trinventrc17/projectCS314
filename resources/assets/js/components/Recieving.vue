        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">            
                    <larapos-autocomplete src="/pos/public/api/products" placeholder="Search product" :select="autocompleteSelect"></larapos-autocomplete>
                </div>
                ...
                <div class="panel-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <larapos-autocomplete src="/pos/public/api/suppliers" placeholder="Search supplier" :select="selectSupplier"></larapos-autocomplete>
                        </div>
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            this.$http.get('/pos/public/api/products').then((products) => {
                this.$set('products', products.body)
            })
        },
        ...
        createReceiving() {
            ...
            {
                this.$http.post('/pos/public/api/receivings', {
                    supplier_id:1,
