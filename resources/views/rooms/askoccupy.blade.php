            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ url('posrooms/' . $customer->id) }}" method="POST">
                       ...
                       <div align="center">
                            <button type="submit" class="btn btn-primary" style="width:70%">Occupy</button>
                       </div>
                    </form>
                    ...
                    <form action="{{ url('posrooms/' . $customer->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="status" name="status" value="Reserved">
                       </div>
                       ...
                       <div align="center">
                            <button type="submit" class="btn btn-primary" style="width:70%">Reserve room</button>
                       </div>
                    </form>
