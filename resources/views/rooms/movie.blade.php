        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-default">
                    ...
                    <div align="center">
                        <a href="{{ url('rooms/' .$id . '/movieGoodFor2') }}">
                        <button type="submit" class="btn btn-primary">Good For 2</button>
                        </a>                       
                    </div>
                        <br>
                    <div align="center">
                        <a href="{{ url('rooms/' .$id . '/movieGoodFor4') }}">
                    ...
                    <div align="center">
                        <a href="{{ url('rooms/' .$id . '/movieGoodFor8') }}">
